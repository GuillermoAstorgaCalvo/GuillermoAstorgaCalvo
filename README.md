...
## 🏢 Professional Code Statistics

> 📊 **Unified stats from my private enterprise repositories**  
> _Updated automatically every Monday via GitHub Actions_

[![View Detailed Stats](https://img.shields.io/badge/📈_View_Detailed_Stats-4A90E2?style=for-the-badge&logo=github&logoColor=white)](./STATS.md)

<details>
<summary>📊 <strong>Quick Overview</strong></summary>
<br>

The detailed stats show **unified contributions** plus **per-repository breakdown** from my private projects:

### 🎯 **Unified Total**

- All Guillermo contributions combined across repositories
- Unified metrics: Total LOC, Commits, Files, and Distribution percentages

### 📁 **Individual Repository Stats**

- 🏠 **InmoIA** (housing-hub-saas) - Main SaaS for Real Estate
- 🏗️ **Typescript Backend** (backend-housing-hub-saas) - Microservices architecture
- 🤖 **Python AI MCP Backend** (IAbackend-inmoIA) - AI system with task completion accuracy

_Full detailed breakdown with comparative metrics available in [STATS.md](./STATS.md)_
